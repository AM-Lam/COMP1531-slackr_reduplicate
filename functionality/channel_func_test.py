...
def test_channel_addowner():
    ...
    # on
    pytest.raises(Value_Error, channel_addowner, user1["token"],
...
def test_channel_details():
    ...
    assert not is_user_member(user2["u_id"], unswchannel["channel_id"])
