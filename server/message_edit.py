...
def message_edit(token, message_id, message):
    ...
    if token_of_message != token:
        raise ValueError(description="You don't have access to edit the message as you are not the poster of the message.")
    ...
    # 2) If the authorised user is an admin, is a any message within a channel that the authorised user has joined
        ...
        raise ValueError(description="Admin don't have the permission to edit the message. ")   
